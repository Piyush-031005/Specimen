...
export class Geometry {
   ...
   */
  render(ctx, outerRotation, innerRotation, masterOpacity, breathScale, behaviorState, stage = 1, timeSinceBirth = 100, fiberSystem, introState, temperament = 0.0) {
    ...
    // ── The Sentient Fiber ─────────────────────────────
    if (fiberSystem) {
      fiberSystem.render(ctx, masterOpacity, cx, cy, introState, temperament);
    }
  }
